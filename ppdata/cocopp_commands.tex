...
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.8.2}}
\providecommand{\numofalgs}{2}
...
%
        ...
        of run lengths and speed-up ratios in 5-D (left) and 20-D (right).
            Left sub-columns: ECDF of the number of $f$-evaluations divided by dimension $D$ (FEvals/D)
        %
        ...
        . Light beige lines show the ECDF of evals for target value
        $\Df=10^{-8}$ of all algorithms benchmarked during
        BBOB-2009. Right sub-columns:
        ECDF of FEvals ratios of \algorithmA\ divided by \algorithmB\ for fixed target
...
\providecommand{\algsfolder}{llm_o_react_120423h3445/}
\providecommand{\algorithmA}{llm optimizer on bbob-0001}
\providecommand{\algorithmB}{react optimizer on bbob-0001}
\providecommand{\bbobecdfcaptionsinglefunctionssingledim}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of $f$-evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
...
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.8.2}}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{react optimizer on bbob{}}
\providecommand{\algfolder}{react_optimizer_on_bbob_120322h5229/}
...
%
        ...
        the best algorithm from BBOB 2009 with a $p$-value of at least $0.05$ or $10^{-k}$
...
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.8.2}}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{llm optimizer on bbob{}}
\providecommand{\algfolder}{llm_optimizer_on_bbob_120322h5109/}
\providecommand{\bbobecdfcaptionallgroups}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of $f$-evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
